      ...
      <div class="container">
        <div class="row end-sm end-md end-lg center-xs middle-xs middle-sm middle-md middle-lg">
          ...
          <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
            <nav id="navbar">
              <ul>
                <li class="current"><a href="cust_req.php">Breakdown List</a></li>
...
<div class="container">
   ...
   <tr>
      ...
      <td><a href="view_break_ad.php?view=<?php echo "$row[bno]";?>"><button class="btn btn-primary"><i class="fas fa-eye"></i></button></a>
        <a href="cust_req.php?delete=<?php echo "$row[bno]";?>"><button class="btn btn-danger"><i class="far fa-trash-alt"></i></button></a>
      </td>
    </tr>
<?php
}
...
$db=mysql_connect("localhost","root");
  ...
  if (isset($_GET['delete'])) {
    ...
    if (!$re) {
      echo "<script>alert('Record Not Deleted!'); location.href='cust_req.php';</script>";
    }else{
      echo "<script>alert('Breakdown Record Deleted!'); location.href='cust_req.php';</script>";
    }
  }
  ?>